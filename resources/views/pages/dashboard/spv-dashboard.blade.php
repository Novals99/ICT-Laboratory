            ...
            <div class="lowstock-list">
                ...
                <div class="lowstock-item">
                    <div class="lowstock-left">
                        <svg class="lowstock-alert" viewBox="0 0 24 24" fill="none"
                    ...
                    <span class="lowstock-count">In stock: {{ $item->stock }}</span>
                </div>
                @empty
        ...
        <div class="table-wrap">
            <table class="db-table">
                <thead>
                    <tr>
                        <th class="th-check">
                            <input type="checkbox" class="db-checkbox" id="checkAll"
