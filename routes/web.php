...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/assets/{asset}/available-spv-serials', [SerialNumberController::class, 'availableSpvSerials'])->name('api.assets.available-spv-serials');
    ...
    Route::get('/api/laboratory/{laboratory}/assets/{asset}/serials-with-pc', [SerialNumberController::class, 'byAssetInLabWithPc'])->name('api.lab.asset-serials-with-pc');
